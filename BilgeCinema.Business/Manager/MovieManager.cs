...
namespace BilgeCinema.Business.Manager
{
	public class MovieManager : IMovieService
	{
        ...
        public bool AddMovie(MovieAddDto movieAddDto)
		{
			var entity = new MovieEntity()
			{
				...
				UnitPrice = movieAddDto.UntiPrice
			};
		...
		public int DeleteMovie(int id)
		{
			...
			// Has query filter ile isDeleted == false eklemeyi unutma !!
		...
		public int MakeDiscount(int id)
		{
			...
			if (entity.IsDiscounted)
				...
				entity.UnitPrice=entity.UnitPrice * 2;
			// %50 indirim uygulanıyor. farklı oranlar istenirse onlarda parametre olarak gönderilmeli 
